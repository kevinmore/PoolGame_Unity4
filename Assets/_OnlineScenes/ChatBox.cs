...
//         GUI.Label(new Rect(cx - 70f, cy - 170f, 120f, 24f), mName);
...
//         }
		...
		mRect = new Rect(cx - 200f, cy + 200f, 400f, 200f);
        //mRect = new Rect(cx - 250f, Screen.height - 250f, 500f, 200f);
        GUI.Window(0, mRect, OnGUIWindow, "Chat With - " + TNManager.players[0].name);
    ...
    void OnGUIWindow(int id)
    {
        ...
        {
            Rect rect = new Rect(4f, 144f, 382f, 200f);
